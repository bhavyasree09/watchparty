...
`;function H0(t){return`
  ...
  `}function X0(t){return""}class sr extends b.HTMLElement{constructor(){if(super(),De(this,_u),De(this,ms),De(this,ps),De(this,co),De(this,Xl),De(this,Jl),De(this,ed),De(this,td),De(this,Lt,void 0),De(this,Wo,void 0),De(this,ls,void 0),De(this,ds,void 0),De(this,ft,{}),De(this,uo,[]),De(this,us,()=>{if(this.range.matches(":focus-visible")){const{style:e}=Te(this.shadowRoot,":host");e.setProperty("--_focus-visible-box-shadow","var(--_focus-box-shadow)")}}),De(this,cs,()=>{const{style:e}=Te(this.shadowRoot,":host");e.removeProperty("--_focus-visible-box-shadow")}),De(this,hs,()=>{const e=this.shadowRoot.querySelector("#segments-clipping");e&&e.parentNode.append(e)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Je(this.attributes),i=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(i):this.shadowRoot.innerHTML=i}this.container=this.shadowRoot.querySelector("#container"),hi(this,ls,this.shadowRoot.querySelector("#startpoint")),hi(this,ds,this.shadowRoot.querySelector("#endpoint")),this.range=this.shadowRoot.querySelector("#range"),this.appearance=this.shadowRoot.querySelector("#appearance")}static get observedAttributes(){return["disabled","aria-disabled",G.MEDIA_CONTROLLER]}attributeChangedCallback(e,i,a){var r,n,s,o,l;e===G.MEDIA_CONTROLLER?(i&&((n=(r=le(this,Lt))==null?void 0:r.unassociateElement)==null||n.call(r,this),hi(this,Lt,null)),a&&this.isConnected&&(hi(this,Lt,(s=this.getRootNode())==null?void 0:s.getElementById(a)),(l=(o=le(this,Lt))==null?void 0:o.associateElement)==null||l.call(o,this))):(e==="disabled"||e==="aria-disabled"&&i!==a)&&(a==null?(this.range.removeAttribute(e),vt(this,ms,Zl).call(this)):(this.range.setAttribute(e,a),vt(this,ps,jl).call(this)))}connectedCallback(){var e,i,a;const{style:r}=Te(this.shadowRoot,":host");r.setProperty("display",`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),le(this,ft).pointer=Te(this.shadowRoot,"#pointer"),le(this,ft).progress=Te(this.shadowRoot,"#progress"),le(this,ft).thumb=Te(this.shadowRoot,'#thumb, ::slotted([slot="thumb"])'),le(this,ft).activeSegment=Te(this.shadowRoot,"#segments-clipping rect:nth-child(0)");const n=this.getAttribute(G.MEDIA_CONTROLLER);n&&(hi(this,Lt,(e=this.getRootNode())==null?void 0:e.getElementById(n)),(a=(i=le(this,Lt))==null?void 0:i.associateElement)==null||a.call(i,this)),this.updateBar(),this.shadowRoot.addEventListener("focusin",le(this,us)),this.shadowRoot.addEventListener("focusout",le(this,cs)),vt(this,ms,Zl).call(this),Xa(this.container,le(this,hs))}disconnectedCallback(){var e,i;vt(this,ps,jl).call(this),(i=(e=le(this,Lt))==null?void 0:e.unassociateElement)==null||i.call(e,this),hi(this,Lt,null),this.shadowRoot.removeEventListener("focusin",le(this,us)),this.shadowRoot.removeEventListener("focusout",le(this,cs)),Ja(this.container,le(this,hs))}updatePointerBar(e){var i;(i=le(this,ft).pointer)==null||i.style.setProperty("width",`${this.getPointerRatio(e)*100}%`)}updateBar(){var e,i;const a=this.range.valueAsNumber*100;(e=le(this,ft).progress)==null||e.style.setProperty("width",`${a}%`),(i=le(this,ft).thumb)==null||i.style.setProperty("left",`${a}%`)}updateSegments(e){const i=this.shadowRoot.querySelector("#segments-clipping");if(i.textContent="",this.container.classList.toggle("segments",!!e?.length),!e?.length)return;const a=[...new Set([+this.range.min,...e.flatMap(n=>[n.start,n.end]),+this.range.max])];hi(this,uo,[...a]);const r=a.pop();for(const[n,s]of a.entries()){const[o,l]=[n===0,n===a.length-1],u=o?"calc(var(--segments-gap) / -1)":`${s*100}%`,p=`calc(${((l?r:a[n+1])-s)*100}%${o||l?"":" - var(--segments-gap)"})`,h=Ee.createElementNS("http://www.w3.org/2000/svg","rect"),d=ru(this.shadowRoot,`#segments-clipping rect:nth-child(${n+1})`);d.style.setProperty("x",u),d.style.setProperty("width",p),i.append(h)}}getPointerRatio(e){return Vg(e.clientX,e.clientY,le(this,ls).getBoundingClientRect(),le(this,ds).getBoundingClientRect())}get dragging(){return this.hasAttribute("dragging")}handleEvent(e){switch(e.type){case"pointermove":vt(this,td,Up).call(this,e);break;case"input":this.updateBar();break;case"pointerenter":vt(this,Xl,Np).call(this,e);break;case"pointerdown":vt(this,co,bu).call(this,e);break;case"pointerup":vt(this,Jl,Pp).call(this);break;case"pointerleave":vt(this,ed,$p).call(this);break}}get keysUsed(){return["ArrowUp","ArrowRight","ArrowDown","ArrowLeft"]}}Lt=new WeakMap;Wo=new WeakMap;ls=new WeakMap;ds=new WeakMap;ft=new WeakMap;uo=new WeakMap;us=new WeakMap;cs=new WeakMap;hs=new WeakMap;_u=new WeakSet;Op=function(t){const e=le(this,ft).activeSegment;if(!e)return;const i=this.getPointerRatio(t),r=`#segments-clipping rect:nth-child(${le(this,uo).findIndex((n,s,o)=>{const l=o[s+1];return l!=null&&i>=n&&i<=l})+1})`;(e.selectorText!=r||!e.style.transform)&&(e.selectorText=r,e.style.setProperty("transform","var(--media-range-segment-hover-transform, scaleY(2))"))};ms=new WeakSet;Zl=function(){this.hasAttribute("disabled")||(this.addEventListener("input",this),this.addEventListener("pointerdown",this),this.addEventListener("pointerenter",this))};ps=new WeakSet;jl=function(){var t,e;this.removeEventListener("input",this),this.removeEventListener("pointerdown",this),this.removeEventListener("pointerenter",this),(t=b.window)==null||t.removeEventListener("pointerup",this),(e=b.window)==null||e.removeEventListener("pointermove",this)};co=new WeakSet;bu=function(t){var e;hi(this,Wo,t.composedPath().includes(this.range)),(e=b.window)==null||e.addEventListener("pointerup",this)};Xl=new WeakSet;Np=function(t){var e;t.pointerType!=="mouse"&&vt(this,co,bu).call(this,t),this.addEventListener("pointerleave",this),(e=b.window)==null||e.addEventListener("pointermove",this)};Jl=new WeakSet;Pp=function(){var t;(t=b.window)==null||t.removeEventListener("pointerup",this),this.toggleAttribute("dragging",!1),this.range.disabled=this.hasAttribute("disabled")};ed=new WeakSet;$p=function(){var t,e;this.removeEventListener("pointerleave",this),(t=b.window)==null||t.removeEventListener("pointermove",this),this.toggleAttribute("dragging",!1),this.range.disabled=this.hasAttribute("disabled"),(e=le(this,ft).activeSegment)==null||e.style.removeProperty("transform")};td=new WeakSet;Up=function(t){t.pointerType==="pen"&&t.buttons===0||(this.toggleAttribute("dragging",t.buttons===1||t.pointerType!=="mouse"),this.updatePointerBar(t),vt(this,_u,Op).call(this,t),this.dragging&&(t.pointerType!=="mouse"||!le(this,Wo))&&(this.range.disabled=!0,this.range.valueAsNumber=this.getPointerRatio(t),this.range.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))))};sr.shadowRootOptions={mode:"open"};sr.getTemplateHTML=j0;sr.getContainerTemplateHTML=X0;b.customElements.get("media-chrome-range")||b.customElements.define("media-chrome-range",sr);var Hp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Ln=(t,e,i)=>(Hp(t,e,"read from private field"),i?i.call(t):e.get(t)),J0=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Dn=(t,e,i,a)=>(Hp(t,e,"write to private field"),e.set(t,i),i),Dt;function ey(t){return`
    ...
    <slot></slot>
  `}class gu extends b.HTMLElement{constructor(){if(super(),J0(this,Dt,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Je(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[G.MEDIA_CONTROLLER]}attributeChangedCallback(e,i,a){var r,n,s,o,l;e===G.MEDIA_CONTROLLER&&(i&&((n=(r=Ln(this,Dt))==null?void 0:r.unassociateElement)==null||n.call(r,this),Dn(this,Dt,null)),a&&this.isConnected&&(Dn(this,Dt,(s=this.getRootNode())==null?void 0:s.getElementById(a)),(l=(o=Ln(this,Dt))==null?void 0:o.associateElement)==null||l.call(o,this)))}connectedCallback(){var e,i,a;const r=this.getAttribute(G.MEDIA_CONTROLLER);r&&(Dn(this,Dt,(e=this.getRootNode())==null?void 0:e.getElementById(r)),(a=(i=Ln(this,Dt))==null?void 0:i.associateElement)==null||a.call(i,this))}disconnectedCallback(){var e,i;(i=(e=Ln(this,Dt))==null?void 0:e.unassociateElement)==null||i.call(e,this),Dn(this,Dt,null)}}Dt=new WeakMap;gu.shadowRootOptions={mode:"open"};gu.getTemplateHTML=ey;b.customElements.get("media-control-bar")||b.customElements.define("media-control-bar",gu);var Bp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Mn=(t,e,i)=>(Bp(t,e,"read from private field"),i?i.call(t):e.get(t)),ty=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},xn=(t,e,i,a)=>(Bp(t,e,"write to private field"),e.set(t,i),i),Mt;function iy(t,e={}){return`
    <style>
      :host {
        font: var(--media-font,
          var(--media-font-weight, normal)
  ...
  `}function ay(t,e){return`
    <slot></slot>
  `}class Si extends b.HTMLElement{constructor(){if(super(),ty(this,Mt,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Je(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[G.MEDIA_CONTROLLER]}attributeChangedCallback(e,i,a){var r,n,s,o,l;e===G.MEDIA_CONTROLLER&&(i&&((n=(r=Mn(this,Mt))==null?void 0:r.unassociateElement)==null||n.call(r,this),xn(this,Mt,null)),a&&this.isConnected&&(xn(this,Mt,(s=this.getRootNode())==null?void 0:s.getElementById(a)),(l=(o=Mn(this,Mt))==null?void 0:o.associateElement)==null||l.call(o,this)))}connectedCallback(){var e,i,a;const{style:r}=Te(this.shadowRoot,":host");r.setProperty("display",`var(--media-control-display, var(--${this.localName}-display, inline-flex))`);const n=this.getAttribute(G.MEDIA_CONTROLLER);n&&(xn(this,Mt,(e=this.getRootNode())==null?void 0:e.getElementById(n)),(a=(i=Mn(this,Mt))==null?void 0:i.associateElement)==null||a.call(i,this))}disconnectedCallback(){var e,i;(i=(e=Mn(this,Mt))==null?void 0:e.unassociateElement)==null||i.call(e,this),xn(this,Mt,null)}}Mt=new WeakMap;Si.shadowRootOptions={mode:"open"};Si.getTemplateHTML=iy;Si.getSlotTemplateHTML=ay;b.customElements.get("media-text-display")||b.customElements.define("media-text-display",Si);var Wp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},oh=(t,e,i)=>(Wp(t,e,"read from private field"),i?i.call(t):e.get(t)),ry=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},ny=(t,e,i,a)=>(Wp(t,e,"write to private field"),e.set(t,i),i),Nr;function sy(t,e){return`
    <slot>${ki(e.mediaDuration)}</slot>
  `}class Fp extends Si{constructor(){var e;super(),ry(this,Nr,void 0),ny(this,Nr,this.shadowRoot.querySelector("slot")),oh(this,Nr).textContent=ki((e=this.mediaDuration)!=null?e:0)}static get observedAttributes(){return[...super.observedAttributes,c.MEDIA_DURATION]}attributeChangedCallback(e,i,a){e===c.MEDIA_DURATION&&(oh(this,Nr).textContent=ki(+a)),super.attributeChangedCallback(e,i,a)}get mediaDuration(){return ie(this,c.MEDIA_DURATION)}set mediaDuration(e){ue(this,c.MEDIA_DURATION,e)}}Nr=new WeakMap;Fp.getSlotTemplateHTML=sy;b.customElements.get("media-duration-display")||b.customElements.define("media-duration-display",Fp);const oy={2:L("Network Error"),3:L("Decode Error"),4:L("Source Not Supported"),5:L("Encryption Error")},ly={2:L("A network error caused the media download to fail."),3:L("A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format."),4:L("An unsupported error occurred. The server or network failed, or your browser does not support this format."),5:L("The media is encrypted and there are no keys to decrypt it.")},Kp=t=>{var e,i;return t.code===1?null:{title:(e=oy[t.code])!=null?e:`Error ${t.code}`,message:(i=ly[t.code])!=null?i:t.message}};var Vp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},dy=(t,e,i)=>(Vp(t,e,"read from private field"),i?i.call(t):e.get(t)),uy=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},cy=(t,e,i,a)=>(Vp(t,e,"write to private field"),e.set(t,i),i),vs;function hy(t){return`
    <style>
      :host {
  ...
  `}function my(t){return t.code&&Kp(t)!==null}function qp(t){var e;const{title:i,message:a}=(e=Kp(t))!=null?e:{};let r="";return i&&(r+=`<slot name="error-${t.code}-title"><h3>${i}</h3></slot>`),a&&(r+=`<slot name="error-${t.code}-message"><p>${a}</p></slot>`),r}const lh=[c.MEDIA_ERROR_CODE,c.MEDIA_ERROR_MESSAGE];class Fo extends nr{constructor(){super(...arguments),uy(this,vs,null)}static get observedAttributes(){return[...super.observedAttributes,...lh]}formatErrorMessage(e){return this.constructor.formatErrorMessage(e)}attributeChangedCallback(e,i,a){var r;if(super.attributeChangedCallback(e,i,a),!lh.includes(e))return;const n=(r=this.mediaError)!=null?r:{code:this.mediaErrorCode,message:this.mediaErrorMessage};this.open=my(n),this.open&&(this.shadowRoot.querySelector("slot").name=`error-${this.mediaErrorCode}`,this.shadowRoot.querySelector("#content").innerHTML=this.formatErrorMessage(n))}get mediaError(){return dy(this,vs)}set mediaError(e){cy(this,vs,e)}get mediaErrorCode(){return ie(this,"mediaerrorcode")}set mediaErrorCode(e){ue(this,"mediaerrorcode",e)}get mediaErrorMessage(){return ae(this,"mediaerrormessage")}set mediaErrorMessage(e){re(this,"mediaerrormessage",e)}}vs=new WeakMap;Fo.getSlotTemplateHTML=hy;Fo.formatErrorMessage=qp;b.customElements.get("media-error-dialog")||b.customElements.define("media-error-dialog",Fo);var Yp=Fo,py=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},di=(t,e,i)=>(py(t,e,"read from private field"),i?i.call(t):e.get(t)),dh=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},ga,ya;function vy(t){return`
    <style>
      :host {
        position: fixed;
        top: 0;
  ...
  `}function fy(){return`
    ...
    `).join("")}</table>
  `}class Gp extends nr{constructor(){super(...arguments),dh(this,ga,e=>{var i;if(!this.open)return;const a=(i=this.shadowRoot)==null?void 0:i.querySelector("#content");if(!a)return;const r=e.composedPath(),n=r[0]===this||r.includes(this),s=r.includes(a);n&&!s&&(this.open=!1)}),dh(this,ya,e=>{if(!this.open)return;const i=e.shiftKey&&(e.key==="/"||e.key==="?");(e.key==="Escape"||i)&&!e.ctrlKey&&!e.altKey&&!e.metaKey&&(this.open=!1,e.preventDefault(),e.stopPropagation())})}connectedCallback(){super.connectedCallback(),this.open&&(this.addEventListener("click",di(this,ga)),document.addEventListener("keydown",di(this,ya)))}disconnectedCallback(){this.removeEventListener("click",di(this,ga)),document.removeEventListener("keydown",di(this,ya))}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e==="open"&&(this.open?(this.addEventListener("click",di(this,ga)),document.addEventListener("keydown",di(this,ya))):(this.removeEventListener("click",di(this,ga)),document.removeEventListener("keydown",di(this,ya))))}}ga=new WeakMap;ya=new WeakMap;Gp.getSlotTemplateHTML=vy;b.customElements.get("media-keyboard-shortcuts-dialog")||b.customElements.define("media-keyboard-shortcuts-dialog",Gp);var zp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Ey=(t,e,i)=>(zp(t,e,"read from private field"),e.get(t)),_y=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},by=(t,e,i,a)=>(zp(t,e,"write to private field"),e.set(t,i),i),fs;const gy=`<svg aria-hidden="true" viewBox="0 0 26 24">
  ...
  `}const uh=t=>{const e=t.mediaIsFullscreen?L("exit fullscreen mode"):L("enter fullscreen mode");t.setAttribute("aria-label",e)};class yu extends Le{constructor(){super(...arguments),_y(this,fs,null)}static get observedAttributes(){return[...super.observedAttributes,c.MEDIA_IS_FULLSCREEN,c.MEDIA_FULLSCREEN_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),uh(this)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===c.MEDIA_IS_FULLSCREEN&&uh(this)}get mediaFullscreenUnavailable(){return ae(this,c.MEDIA_FULLSCREEN_UNAVAILABLE)}set mediaFullscreenUnavailable(e){re(this,c.MEDIA_FULLSCREEN_UNAVAILABLE,e)}get mediaIsFullscreen(){return F(this,c.MEDIA_IS_FULLSCREEN)}set mediaIsFullscreen(e){K(this,c.MEDIA_IS_FULLSCREEN,e)}handleClick(e){by(this,fs,e);const i=Ey(this,fs)instanceof PointerEvent,a=this.mediaIsFullscreen?new b.CustomEvent(C.MEDIA_EXIT_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0}):new b.CustomEvent(C.MEDIA_ENTER_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0,detail:i});this.dispatchEvent(a)}}fs=new WeakMap;yu.getSlotTemplateHTML=Ty;yu.getTooltipContentHTML=Ay;b.customElements.get("media-fullscreen-button")||b.customElements.define("media-fullscreen-button",yu);const{MEDIA_TIME_IS_LIVE:Es,MEDIA_PAUSED:Zr}=c,{MEDIA_SEEK_TO_LIVE_REQUEST:ky,MEDIA_PLAY_REQUEST:wy}=C,Sy='<svg viewBox="0 0 6 12"><circle cx="3" cy="6" r="2"></circle></svg>';function Iy(t){return`
    <style>
...
`;function Cy(t){return`
...
</svg>`,Dy=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  `}const fh=t=>{const e=t.mediaIsPip?L("exit picture in picture mode"):L("enter picture in picture mode");t.setAttribute("aria-label",e)};class ku extends Le{static get observedAttributes(){return[...super.observedAttributes,c.MEDIA_IS_PIP,c.MEDIA_PIP_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),fh(this)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===c.MEDIA_IS_PIP&&fh(this)}get mediaPipUnavailable(){return ae(this,c.MEDIA_PIP_UNAVAILABLE)}set mediaPipUnavailable(e){re(this,c.MEDIA_PIP_UNAVAILABLE,e)}get mediaIsPip(){return F(this,c.MEDIA_IS_PIP)}set mediaIsPip(e){K(this,c.MEDIA_IS_PIP,e)}handleClick(){const e=this.mediaIsPip?C.MEDIA_EXIT_PIP_REQUEST:C.MEDIA_ENTER_PIP_REQUEST;this.dispatchEvent(new b.CustomEvent(e,{composed:!0,bubbles:!0}))}}ku.getSlotTemplateHTML=Oy;ku.getTooltipContentHTML=Ny;b.customElements.get("media-pip-button")||b.customElements.define("media-pip-button",ku);var Py=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},ua=(t,e,i)=>(Py(t,e,"read from private field"),i?i.call(t):e.get(t)),$y=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},mi;const ll={RATES:"rates"},Xp=[1,1.2,1.5,1.7,2],Ha=1;function Uy(t){return`
    <style>
      :host {
        min-width: 5ch;
  ...
  `}function Hy(){return L("Playback rate")}class wu extends Le{constructor(){var e;super(),$y(this,mi,new ou(this,ll.RATES,{defaultValue:Xp})),this.container=this.shadowRoot.querySelector('slot[name="icon"]'),this.container.innerHTML=`${(e=this.mediaPlaybackRate)!=null?e:Ha}x`}static get observedAttributes(){return[...super.observedAttributes,c.MEDIA_PLAYBACK_RATE,ll.RATES]}attributeChangedCallback(e,i,a){if(super.attributeChangedCallback(e,i,a),e===ll.RATES&&(ua(this,mi).value=a),e===c.MEDIA_PLAYBACK_RATE){const r=a?+a:Number.NaN,n=Number.isNaN(r)?Ha:r;this.container.innerHTML=`${n}x`,this.setAttribute("aria-label",L("Playback rate {playbackRate}",{playbackRate:n}))}}get rates(){return ua(this,mi)}set rates(e){e?Array.isArray(e)?ua(this,mi).value=e.join(" "):typeof e=="string"&&(ua(this,mi).value=e):ua(this,mi).value=""}get mediaPlaybackRate(){return ie(this,c.MEDIA_PLAYBACK_RATE,Ha)}set mediaPlaybackRate(e){ue(this,c.MEDIA_PLAYBACK_RATE,e)}handleClick(){var e,i;const a=Array.from(ua(this,mi).values(),s=>+s).sort((s,o)=>s-o),r=(i=(e=a.find(s=>s>this.mediaPlaybackRate))!=null?e:a[0])!=null?i:Ha,n=new b.CustomEvent(C.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:r});this.dispatchEvent(n)}}mi=new WeakMap;wu.getSlotTemplateHTML=Uy;wu.getTooltipContentHTML=Hy;b.customElements.get("media-playback-rate-button")||b.customElements.define("media-playback-rate-button",wu);const By=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  `}const qy=t=>{t.style.removeProperty("background-image")},Yy=(t,e)=>{t.style["background-image"]=`url('${e}')`};class Iu extends b.HTMLElement{static get observedAttributes(){return[At.PLACEHOLDER_SRC,At.SRC]}constructor(){if(super(),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);const e=Je(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}this.image=this.shadowRoot.querySelector("#image")}attributeChangedCallback(e,i,a){e===At.SRC&&(a==null?this.image.removeAttribute(At.SRC):this.image.setAttribute(At.SRC,a)),e===At.PLACEHOLDER_SRC&&(a==null?qy(this.image):Yy(this.image,a))}get placeholderSrc(){return ae(this,At.PLACEHOLDER_SRC)}set placeholderSrc(e){re(this,At.SRC,e)}get src(){return ae(this,At.SRC)}set src(e){re(this,At.SRC,e)}}Iu.shadowRootOptions={mode:"open"};Iu.getTemplateHTML=Vy;b.customElements.get("media-poster-image")||b.customElements.define("media-poster-image",Iu);var Jp=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Gy=(t,e,i)=>(Jp(t,e,"read from private field"),i?i.call(t):e.get(t)),zy=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Qy=(t,e,i,a)=>(Jp(t,e,"write to private field"),e.set(t,i),i),bs;class Zy extends Si{constructor(){super(),zy(this,bs,void 0),Qy(this,bs,this.shadowRoot.querySelector("slot"))}static get observedAttributes(){return[...super.observedAttributes,c.MEDIA_PREVIEW_CHAPTER,c.MEDIA_LANG]}attributeChangedCallback(e,i,a){if(super.attributeChangedCallback(e,i,a),(e===c.MEDIA_PREVIEW_CHAPTER||e===c.MEDIA_LANG)&&a!==i&&a!=null)if(Gy(this,bs).textContent=a,a!==""){const r=L("chapter: {chapterName}",{chapterName:a});this.setAttribute("aria-valuetext",r)}else this.removeAttribute("aria-valuetext")}get mediaPreviewChapter(){return ae(this,c.MEDIA_PREVIEW_CHAPTER)}set mediaPreviewChapter(e){re(this,c.MEDIA_PREVIEW_CHAPTER,e)}}bs=new WeakMap;b.customElements.get("media-preview-chapter-display")||b.customElements.define("media-preview-chapter-display",Zy);var ev=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Nn=(t,e,i)=>(ev(t,e,"read from private field"),i?i.call(t):e.get(t)),jy=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Pn=(t,e,i,a)=>(ev(t,e,"write to private field"),e.set(t,i),i),Ot;function Xy(t){return`
    <style>
      :host {
        box-sizing: border-box;
  ...
  <svg aria-hidden="true" viewBox="0 0 20 24">
    ...
    <slot name="icon">${i1(e.seekOffset)}</slot>
  `}function r1(){return L("Seek backward")}const n1=0;class Ru extends Le{static get observedAttributes(){return[...super.observedAttributes,c.MEDIA_CURRENT_TIME,ca.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=ie(this,ca.SEEK_OFFSET,dl)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===ca.SEEK_OFFSET&&(this.seekOffset=ie(this,ca.SEEK_OFFSET,dl))}get seekOffset(){return ie(this,ca.SEEK_OFFSET,dl)}set seekOffset(e){ue(this,ca.SEEK_OFFSET,e),this.setAttribute("aria-label",L("seek back {seekOffset} seconds",{seekOffset:this.seekOffset})),op(lp(this,"icon"),this.seekOffset)}get mediaCurrentTime(){return ie(this,c.MEDIA_CURRENT_TIME,n1)}set mediaCurrentTime(e){ue(this,c.MEDIA_CURRENT_TIME,e)}handleClick(){const e=Math.max(this.mediaCurrentTime-this.seekOffset,0),i=new b.CustomEvent(C.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(i)}}Ru.getSlotTemplateHTML=a1;Ru.getTooltipContentHTML=r1;b.customElements.get("media-seek-backward-button")||b.customElements.define("media-seek-backward-button",Ru);const ha={SEEK_OFFSET:"seekoffset"},ul=30,s1=t=>`
  <svg aria-hidden="true" viewBox="0 0 20 24">
    <defs>
      <style>.text{font-size:8px;font-family:Arial-BoldMT, Arial;font-weight:700;}</style>
    </defs>
  ...
  </svg>`;function o1(t,e){return`
    <slot name="icon">${s1(e.seekOffset)}</slot>
  `}function l1(){return L("Seek forward")}const d1=0;class Cu extends Le{static get observedAttributes(){return[...super.observedAttributes,c.MEDIA_CURRENT_TIME,ha.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=ie(this,ha.SEEK_OFFSET,ul)}attributeChangedCallback(e,i,a){super.attributeChangedCallback(e,i,a),e===ha.SEEK_OFFSET&&(this.seekOffset=ie(this,ha.SEEK_OFFSET,ul))}get seekOffset(){return ie(this,ha.SEEK_OFFSET,ul)}set seekOffset(e){ue(this,ha.SEEK_OFFSET,e),this.setAttribute("aria-label",L("seek forward {seekOffset} seconds",{seekOffset:this.seekOffset})),op(lp(this,"icon"),this.seekOffset)}get mediaCurrentTime(){return ie(this,c.MEDIA_CURRENT_TIME,d1)}set mediaCurrentTime(e){ue(this,c.MEDIA_CURRENT_TIME,e)}handleClick(){const e=this.mediaCurrentTime+this.seekOffset,i=new b.CustomEvent(C.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(i)}}Cu.getSlotTemplateHTML=o1;Cu.getTooltipContentHTML=l1;b.customElements.get("media-seek-forward-button")||b.customElements.define("media-seek-forward-button",Cu);var iv=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},cl=(t,e,i)=>(iv(t,e,"read from private field"),i?i.call(t):e.get(t)),u1=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},c1=(t,e,i,a)=>(iv(t,e,"write to private field"),e.set(t,i),i),Ta;const Ni={REMAINING:"remaining",SHOW_DURATION:"showduration",NO_TOGGLE:"notoggle"},gh=[...Object.values(Ni),c.MEDIA_CURRENT_TIME,c.MEDIA_DURATION,c.MEDIA_SEEKABLE],yh=["Enter"," "],h1="&nbsp;/&nbsp;",id=(t,{timesSep:e=h1}={})=>{var i,a;const r=(i=t.mediaCurrentTime)!=null?i:0,[,n]=(a=t.mediaSeekable)!=null?a:[];let s=0;Number.isFinite(t.mediaDuration)?s=t.mediaDuration:Number.isFinite(n)&&(s=n);const o=t.remaining?ki(0-(s-r)):ki(r);return t.showDuration?`${o}${e}${ki(s)}`:o},m1="video not loaded, unknown time.",p1=t=>{var e;const i=t.mediaCurrentTime,[,a]=(e=t.mediaSeekable)!=null?e:[];let r=null;if(Number.isFinite(t.mediaDuration)?r=t.mediaDuration:Number.isFinite(a)&&(r=a),i==null||r===null){t.setAttribute("aria-valuetext",m1);return}const n=t.remaining?zr(0-(r-i)):zr(i);if(!t.showDuration){t.setAttribute("aria-valuetext",n);return}const s=zr(r),o=`${n} of ${s}`;t.setAttribute("aria-valuetext",o)};function v1(t,e){return`
    <slot>${id(e)}</slot>
  `}class av extends Si{constructor(){super(),u1(this,Ta,void 0),c1(this,Ta,this.shadowRoot.querySelector("slot")),cl(this,Ta).innerHTML=`${id(this)}`}static get observedAttributes(){return[...super.observedAttributes,...gh,"disabled"]}connectedCallback(){const{style:e}=Te(this.shadowRoot,":host(:hover:not([notoggle]))");e.setProperty("cursor","var(--media-cursor, pointer)"),e.setProperty("background","var(--media-control-hover-background, rgba(50 50 70 / .7))"),this.hasAttribute("disabled")||this.enable(),this.setAttribute("role","progressbar"),this.setAttribute("aria-label",L("playback time"));const i=a=>{const{key:r}=a;if(!yh.includes(r)){this.removeEventListener("keyup",i);return}this.toggleTimeDisplay()};this.addEventListener("keydown",a=>{const{metaKey:r,altKey:n,key:s}=a;if(r||n||!yh.includes(s)){this.removeEventListener("keyup",i);return}this.addEventListener("keyup",i)}),this.addEventListener("click",this.toggleTimeDisplay),super.connectedCallback()}toggleTimeDisplay(){this.noToggle||(this.hasAttribute("remaining")?this.removeAttribute("remaining"):this.setAttribute("remaining",""))}disconnectedCallback(){this.disable(),super.disconnectedCallback()}attributeChangedCallback(e,i,a){gh.includes(e)?this.update():e==="disabled"&&a!==i&&(a==null?this.enable():this.disable()),super.attributeChangedCallback(e,i,a)}enable(){this.tabIndex=0}disable(){this.tabIndex=-1}get remaining(){return F(this,Ni.REMAINING)}set remaining(e){K(this,Ni.REMAINING,e)}get showDuration(){return F(this,Ni.SHOW_DURATION)}set showDuration(e){K(this,Ni.SHOW_DURATION,e)}get noToggle(){return F(this,Ni.NO_TOGGLE)}set noToggle(e){K(this,Ni.NO_TOGGLE,e)}get mediaDuration(){return ie(this,c.MEDIA_DURATION)}set mediaDuration(e){ue(this,c.MEDIA_DURATION,e)}get mediaCurrentTime(){return ie(this,c.MEDIA_CURRENT_TIME)}set mediaCurrentTime(e){ue(this,c.MEDIA_CURRENT_TIME,e)}get mediaSeekable(){const e=this.getAttribute(c.MEDIA_SEEKABLE);if(e)return e.split(":").map(i=>+i)}set mediaSeekable(e){if(e==null){this.removeAttribute(c.MEDIA_SEEKABLE);return}this.setAttribute(c.MEDIA_SEEKABLE,e.join(":"))}update(){const e=id(this);p1(this),e!==cl(this,Ta).innerHTML&&(cl(this,Ta).innerHTML=e)}}Ta=new WeakMap;av.getSlotTemplateHTML=v1;b.customElements.get("media-time-display")||b.customElements.define("media-time-display",av);var rv=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Ie=(t,e,i)=>(rv(t,e,"read from private field"),e.get(t)),kt=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Qe=(t,e,i,a)=>(rv(t,e,"write to private field"),e.set(t,i),i),f1=(t,e,i,a)=>({set _(r){Qe(t,e,r)},get _(){return Ie(t,e)}}),Aa,gs,ka,$r,ys,Ts,As,wa,Pi,ks;class E1{constructor(e,i,a){kt(this,Aa,void 0),kt(this,gs,void 0),kt(this,ka,void 0),kt(this,$r,void 0),kt(this,ys,void 0),kt(this,Ts,void 0),kt(this,As,void 0),kt(this,wa,void 0),kt(this,Pi,0),kt(this,ks,(r=performance.now())=>{Qe(this,Pi,requestAnimationFrame(Ie(this,ks))),Qe(this,$r,performance.now()-Ie(this,ka));const n=1e3/this.fps;if(Ie(this,$r)>n){Qe(this,ka,r-Ie(this,$r)%n);const s=1e3/((r-Ie(this,gs))/++f1(this,ys)._),o=(r-Ie(this,Ts))/1e3/this.duration;let l=Ie(this,As)+o*this.playbackRate;l-Ie(this,Aa).valueAsNumber>0?Qe(this,wa,this.playbackRate/this.duration/s):(Qe(this,wa,.995*Ie(this,wa)),l=Ie(this,Aa).valueAsNumber+Ie(this,wa)),this.callback(l)}}),Qe(this,Aa,e),this.callback=i,this.fps=a}start(){Ie(this,Pi)===0&&(Qe(this,ka,performance.now()),Qe(this,gs,Ie(this,ka)),Qe(this,ys,0),Ie(this,ks).call(this))}stop(){Ie(this,Pi)!==0&&(cancelAnimationFrame(Ie(this,Pi)),Qe(this,Pi,0))}update({start:e,duration:i,playbackRate:a}){const r=e-Ie(this,Aa).valueAsNumber,n=Math.abs(i-this.duration);(r>0||r<-.03||n>=.5)&&this.callback(e),Qe(this,As,e),Qe(this,Ts,performance.now()),this.duration=i,this.playbackRate=a}}Aa=new WeakMap;gs=new WeakMap;ka=new WeakMap;$r=new WeakMap;ys=new WeakMap;Ts=new WeakMap;As=new WeakMap;wa=new WeakMap;Pi=new WeakMap;ks=new WeakMap;var Lu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},ce=(t,e,i)=>(Lu(t,e,"read from private field"),i?i.call(t):e.get(t)),be=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},at=(t,e,i,a)=>(Lu(t,e,"write to private field"),e.set(t,i),i),Ne=(t,e,i)=>(Lu(t,e,"access private method"),i),Sa,Ji,ho,jr,mo,ws,hn,mn,Ia,Ra,Ca,Ur,Du,nv,ad,po,Mu,vo,xu,fo,Ou,rd,sv,pn,Eo,nd,ov;const _1="video not loaded, unknown time.",b1=t=>{const e=t.range,i=zr(+lv(t)),a=zr(+t.mediaSeekableEnd),r=i&&a?`${i} of ${a}`:_1;e.setAttribute("aria-valuetext",r)};function g1(t){return`
    <style>
      :host {
...
`;class qo extends b.HTMLElement{constructor(){super(),_r(this,ld),_r(this,Cs),_r(this,qa,void 0),_r(this,Rs,void 0),_r(this,Ya,void 0),this.shadowRoot?this.renderRoot=this.shadowRoot:(this.renderRoot=this.attachShadow({mode:"open"}),this.createRenderer());const e=new MutationObserver(i=>{var a;this.mediaController&&!((a=this.mediaController)!=null&&a.breakpointsComputed)||i.some(r=>{const n=r.target;return n===this?!0:n.localName!=="media-controller"?!1:!!(ml[r.attributeName]||r.attributeName.startsWith("breakpoint"))})&&this.render()});e.observe(this,{attributes:!0}),e.observe(this.renderRoot,{attributes:!0,subtree:!0}),this.addEventListener(ai.BREAKPOINTS_COMPUTED,this.render),hl(this,ld,fv).call(this,"template")}get mediaController(){return this.renderRoot.querySelector("media-controller")}get template(){var e;return(e=od(this,qa))!=null?e:this.constructor.template}set template(e){if(e===null){this.removeAttribute("template");return}typeof e=="string"?this.setAttribute("template",e):e instanceof HTMLTemplateElement&&(Qi(this,qa,e),Qi(this,Ya,null),this.createRenderer())}get props(){var e,i,a;const r=[...Array.from((i=(e=this.mediaController)==null?void 0:e.attributes)!=null?i:[]).filter(({name:s})=>ml[s]||s.startsWith("breakpoint")),...Array.from(this.attributes)],n={};for(const s of r){const o=(a=ml[s.name])!=null?a:$g(s.name);let{value:l}=s;l!=null?(Jm(l)&&(l=parseFloat(l)),n[o]=l===""?!0:l):n[o]=!1}return n}attributeChangedCallback(e,i,a){e==="template"&&i!=a&&hl(this,Cs,dd).call(this)}connectedCallback(){hl(this,Cs,dd).call(this)}createRenderer(){this.template instanceof HTMLTemplateElement&&this.template!==od(this,Rs)&&(Qi(this,Rs,this.template),this.renderer=new Vo(this.template,this.props,this.constructor.processor),this.renderRoot.textContent="",this.renderRoot.append(Ev.content.cloneNode(!0),this.renderer))}render(){var e;(e=this.renderer)==null||e.update(this.props)}}qa=new WeakMap;Rs=new WeakMap;Ya=new WeakMap;ld=new WeakSet;fv=function(t){if(Object.prototype.hasOwnProperty.call(this,t)){const e=this[t];delete this[t],this[t]=e}};Cs=new WeakSet;dd=function(){var t;const e=this.getAttribute("template");if(!e||e===od(this,Ya))return;const i=this.getRootNode(),a=(t=i?.getElementById)==null?void 0:t.call(i,e);if(a){Qi(this,Ya,e),Qi(this,qa,a),this.createRenderer();return}N1(e)&&(Qi(this,Ya,e),P1(e).then(r=>{const n=Ee.createElement("template");n.innerHTML=r,Qi(this,qa,n),this.createRenderer()}).catch(console.error))};qo.observedAttributes=["template"];qo.processor=$u;function N1(t){if(!/^(\/|\.\/|https?:\/\/)/.test(t))return!1;const e=/^https?:\/\//.test(t)?void 0:location.origin;try{new URL(t,e)}catch{return!1}return!0}async function P1(t){const e=await fetch(t);if(e.status!==200)throw new Error(`Failed to load resource: the server responded with a status of ${e.status}`);return e.text()}b.customElements.get("media-theme")||b.customElements.define("media-theme",qo);function $1({anchor:t,floating:e,placement:i}){const a=U1({anchor:t,floating:e}),{x:r,y:n}=B1(a,i);return{x:r,y:n}}function U1({anchor:t,floating:e}){return{anchor:H1(t,e.offsetParent),floating:{x:0,y:0,width:e.offsetWidth,height:e.offsetHeight}}}function H1(t,e){var i;const a=t.getBoundingClientRect(),r=(i=e?.getBoundingClientRect())!=null?i:{x:0,y:0};return{x:a.x-r.x,y:a.y-r.y,width:a.width,height:a.height}}function B1({anchor:t,floating:e},i){const a=W1(i)==="x"?"y":"x",r=a==="y"?"height":"width",n=_v(i),s=t.x+t.width/2-e.width/2,o=t.y+t.height/2-e.height/2,l=t[r]/2-e[r]/2;let u;switch(n){case"top":u={x:s,y:t.y-e.height};break;case"bottom":u={x:s,y:t.y+t.height};break;case"right":u={x:t.x+t.width,y:o};break;case"left":u={x:t.x-e.width,y:o};break;default:u={x:t.x,y:t.y}}switch(i.split("-")[1]){case"start":u[a]-=l;break;case"end":u[a]+=l;break}return u}function _v(t){return t.split("-")[0]}function W1(t){return["top","bottom"].includes(_v(t))?"y":"x"}class Hu extends Event{constructor({action:e="auto",relatedTarget:i,...a}){super("invoke",a),this.action=e,this.relatedTarget=i}}class F1 extends Event{constructor({newState:e,oldState:i,...a}){super("toggle",a),this.newState=e,this.oldState=i}}var Bu=(t,e,i)=>{if(!e.has(t))throw TypeError("Cannot "+i)},Y=(t,e,i)=>(Bu(t,e,"read from private field"),i?i.call(t):e.get(t)),J=(t,e,i)=>{if(e.has(t))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(t):e.set(t,i)},Nt=(t,e,i,a)=>(Bu(t,e,"write to private field"),e.set(t,i),i),ee=(t,e,i)=>(Bu(t,e,"access private method"),i),Pt,ea,wi,Ls,Ds,ta,vn,ud,bv,_o,Wu,bo,Ms,cd,hd,gv,md,yv,pd,Tv,Ga,za,Qa,fn,go,Fu,vd,Av,Ku,kv,fd,wv,Vu,Sv,Ed,Iv,_d,Rv,Xr,yo,bd,Cv,Jr,To,xs,gd;function tr({type:t,text:e,value:i,checked:a}){const r=Ee.createElement("media-chrome-menu-item");r.type=t,r.part.add("menu-item"),r.part.add(t),r.value=i,r.checked=a;const n=Ee.createElement("span");return n.textContent=e,r.append(n),r}function ia(t,e){let i=t.querySelector(`:scope > [slot="${e}"]`);if(i?.nodeName=="SLOT"&&(i=i.assignedElements({flatten:!0})[0]),i)return i=i.cloneNode(!0),i;const a=t.shadowRoot.querySelector(`[name="${e}"] > svg`);return a?a.cloneNode(!0):""}function K1(t){return`
  ...
  `}class xv extends ot{get anchorElement(){return this.anchor!=="auto"?super.anchorElement:We(this).querySelector("media-settings-menu-button")}}xv.getTemplateHTML=G1;b.customElements.get("media-settings-menu")||b.customElements.define("media-settings-menu",xv);function z1(t){return`
